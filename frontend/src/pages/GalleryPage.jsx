  ...
  const galleryItems = [
    {
      ...
      thumb:
        "https://images.unsplash.com/photo-1517694712202-14dd9538aa97?w=400&q=20&blur=10",
    ...
    },
    {
      ...
      thumb:
        "https://images.unsplash.com/photo-1552664730-d307ca884978?w=400&q=20&blur=10",
      alt: "Design mockup",
      category: "design",
      title: "UI Components",
    ...
    },
    {
      ...
      thumb:
        "https://images.unsplash.com/photo-1561070791-2526d30994b5?w=400&q=20&blur=10",
      alt: "UI design",
      category: "design",
    ...
    },
    {
      ...
      thumb:
        "https://images.unsplash.com/photo-1554050857-4d192d92225b?w=400&q=20&blur=10",
      alt: "Web development",
      category: "projects",
    ...
    },
    {
      ...
      thumb:
        "https://images.unsplash.com/photo-1611532736579-6b16e2b50449?w=400&q=20&blur=10",
      alt: "Mobile app",
      category: "projects",
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-12 text-center space-y-4 animate-fadeIn">
            <div className="inline-flex items-center justify-center">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-black mx-4 bg-clip-text text-transparent bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500">
                Gallery
              </h1>
            ...
            {filtered.map((item, index) => (
              ...
              >
                ...
                <div className="w-full h-full relative bg-gradient-to-br from-gray-800 to-gray-900">
                  ...
                  {/* Gradient Overlay */}
                  <div
                    className={`absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300`}
                  ></div>
          ...
          >
            ...
            <div className="absolute top-4 sm:top-6 left-4 sm:left-6 right-4 sm:right-6 flex justify-between items-start z-10">
              <div className="hidden sm:block text-white">
                <h2 className="font-bold text-xl mb-1">{selectedItem.title}</h2>
