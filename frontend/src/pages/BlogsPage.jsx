...
const BlogsPage = () => {
  ...
  return (
    ...
    >
      ...
      {selectedBlog && (
        <div
          className="fixed top-0 left-0 right-0 h-1 bg-gradient-to-r from-blue-500 to-purple-500 z-40"
            ...
            <>
              ...
              <div className="mb-12 text-center space-y-4 animate-fadeIn">
                <div className="inline-flex items-center justify-center gap-4">
                  ...
                  <h1 className="text-4xl md:text-5xl lg:text-6xl font-black bg-clip-text text-transparent bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500">
                    Blogs
                  </h1>
