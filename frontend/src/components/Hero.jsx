...
function Hero() {
  ...
  return (
    <section
      id="home"
      className={`pt-32 pb-20 px-4 min-h-screen flex items-center transition-all duration-500 ${
        darkMode
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 items-center">
          ...
          <div className="space-y-6 order-last md:order-first">
            ...
            <div className="flex flex-row gap-3 pt-4 md:pt-6 w-fit">
              ...
              <ButtonSecondary
                className={`flex items-center justify-center cursor-pointer truncate font-semibold text-sm md:text-base px-5 md:px-7 py-2.5 md:py-3 rounded-xl backdrop-blur-md transition-all duration-300 ${
                  darkMode
                    ...
                    : "bg-linear-to-r from-white/50 to-blue-50/50 border-2 border-blue-300/50 text-gray-600! hover:text-gray-700! hover:bg-gray-300! font-mono hover:from-blue-100/70 hover:to-blue-50/70 hover:border-purple-400/70 hover:shadow-lg hover:shadow-purple-400/40 hover:scale-105 active:scale-95"
                }`}
              >
                Download CV
              </ButtonSecondary>
